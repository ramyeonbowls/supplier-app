<template>
    <div class="rounded-2xl border border-blue-100 bg-white p-4 shadow-lg sm:p-6 lg:p-8" role="alert">
        <div class="flex items-center gap-4">
            ...
            <p class="font-medium sm:text-lg">Verify Your Email Address!</p>
        </div>

        <p class="mt-4 text-gray-500">Before proceeding, please check your email for a verification link. If you did not receive the email</p>
            ...
            <form @submit.prevent="handleSubmit($event, submit)">
                <div class="mt-6 sm:flex sm:gap-4">
                    <button type="submit" class="group relative inline-flex items-center overflow-hidden rounded bg-indigo-600 px-8 py-3 text-white focus:outline-none focus:ring active:bg-indigo-500">
                        ...
                        <span class="text-sm font-medium transition-all group-hover:ms-4"> Click here to request another </span>
                    </button>
                </div>
            </form>
        </VeeForm>
