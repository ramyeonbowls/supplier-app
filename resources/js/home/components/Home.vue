<template>
    <div class="w-100 h-100 mx-auto overflow-hidden rounded-lg bg-white shadow-md">
        <div class="flex flex-col gap-4 p-6">
            ...
            <div :class="user.role === 0 ? '' : 'hidden'" class="mt-2 grid grid-cols-12 gap-4">
                ...
                <div class="col-span-6 rounded-lg shadow-sm sm:col-span-3">
                    <article class="flex items-center gap-4 rounded-lg border border-gray-100 bg-white p-2 sm:p-6">
                        ...
                        <div>
                            <p class="text-1xl font-medium text-gray-900 sm:text-2xl">{{ dashboard.publisher }}</p>

                            <p class="text-sm font-semibold text-gray-500">Total Penerbit</p>
                        </div>
                    </article>
                </div>
                <div class="col-span-6 rounded-lg shadow-sm sm:col-span-3">
            ...
            <a href="#" :class="user.role === 1 || user.role === 2 ? '' : 'hidden'" class="relative block overflow-hidden rounded-lg border border-gray-100 p-4 sm:p-6 lg:p-8">
        ...
        getDashboard() {
            ...
            window.axios
                ...
                .then((response) => {
                    ...
                    this.dashboard.publisher = response.data.publisher
                })
                .catch((e) => {
                    console.error(e)
                })
