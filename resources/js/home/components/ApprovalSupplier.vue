...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            window.axios
                .get('/transactions/approval-supplier', {
                    params: {
                        param: this.selected,
                    },
                })
        ...
        submit() {
            if (!this.form.submitted) {
                ...
                if (this.selectedRows.length > 0) {
                    let loader = this.$loading.show()
                    window.axios
                        .post('/transactions/approval-supplier?menu=' + this.$route.name, this.selectedRows)
                        .then((response) => {
        ...
        reject() {
            if (!this.form.submitted) {
                ...
                if (this.selectedRows.length > 0) {
                    let loader = this.$loading.show()
                    window.axios
                        .post('/transactions/approval-supplier/reject?menu=' + this.$route.name, this.selectedRows)
                        .then((response) => {
                            this.form.submitted = false
                            this.selectedRows = []
                            this.getData()
