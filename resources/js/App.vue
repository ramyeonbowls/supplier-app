<template>
    ...
    <main class="mb-auto mt-1">
        <!-- <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4">
                    <div class="h-32 rounded-lg">
                        <section class="overflow-hidden rounded-lg bg-[url(https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?q=80&w=2670&auto=format&fit=crop)] bg-cover bg-top bg-no-repeat">
                            <div class="bg-black/50 p-8 md:p-12 lg:px-16 lg:py-24">
                                <div class="rtl:sm:text-right">
                                    <h2 class="text-2xl font-bold text-white sm:text-3xl md:text-5xl">Lorem ipsum dolor</h2>

                                    <p class="hidden max-w-lg text-white/90 md:mt-6 md:block md:text-lg md:leading-relaxed">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Inventore officia corporis quasi doloribus iure architecto quae voluptatum beatae excepturi dolores.</p>

                                    <div class="mt-4 sm:mt-8">
                                        <a href="#" class="inline-block rounded-full bg-teal-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-teal-700 focus:outline-none focus:ring focus:ring-teal-400"> Get Yours Today </a>
                                    </div>
                                </div>
                            </div>
                        </section>
        ...
        <section class="mt-6 overflow-hidden bg-[url(https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?q=80&w=2670&auto=format&fit=crop)] bg-cover bg-top bg-no-repeat">
            <div class="bg-black/50 p-8 md:p-12 lg:px-16 lg:py-24">
                <div class="ltr:sm:text-left">
                    <h2 class="text-2xl font-bold text-white sm:text-3xl md:text-5xl">Genesia app</h2>
        ...
        <section>
            <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                <header class="text-center">
                    ...
                    <p class="mx-auto mt-4 max-w-md text-gray-500">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Itaque praesentium cumque iure dicta incidunt est ipsam, officia dolor fugit natus?</p>
                </header>
                    ...
                    <li>
                        <a href="#" class="group relative block">
                            ...
                            <div class="absolute inset-0 flex flex-col items-start justify-end p-6">
                                ...
                                <span class="mt-1.5 inline-block bg-black px-5 py-3 text-xs font-medium uppercase tracking-wide text-white"> Shop Now </span>
                            </div>
                        </a>
                    </li>
    ...
    <footer class="mt-10 h-10 bg-white">
