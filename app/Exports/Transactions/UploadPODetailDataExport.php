...
class UploadPODetailDataExport implements WithCustomStartCell, WithEvents
{
    ...
    public function registerEvents(): array
    {
        return [
            BeforeExport::class => function(BeforeExport $event) {
                $event->writer->getProperties()->setTitle('Laporan PO Supplier');
            ...
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->mergeCells('A1:G1')->setCellValue('A1', 'Laporan PO Supplier');
